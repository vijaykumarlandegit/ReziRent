...
class HostelOwnAdapter(var context: Context?, var list: ArrayList<SingleIDClass?>) :
    RecyclerView.Adapter<HostelOwnAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.hostelownsample, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        InterstitialAd.load(
            context!!, R.string.Ownhosteleditinterstitial_id.toString(), adRequestedit,
        ...
        InterstitialAd.load(
            context!!, R.string.Ownhostelshowinterstitial_id.toString(), adRequestshow,
            object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    // The mInterstitialAd reference will be null until
                    // an ad is loaded.
        ...
        holder.binding.editview.setOnClickListener {
            if (mInterstitialAdedit != null) {
                    ...
                    mInterstitialAdedit!!.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            override fun onAdDismissedFullScreenContent() {
                                ...
                                mInterstitialAdedit = null
                                val intent =
                                    Intent(context, EditHostelDataActivity::class.java)
                ...
                val intent = Intent(context, EditHostelDataActivity::class.java)
                intent.putExtra("id", id)
                context!!.startActivity(intent)
            }
        }
                    ...
                    mInterstitialAdshow!!.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            override fun onAdDismissedFullScreenContent() {
                                ...
                                mInterstitialAdshow = null
                                val intent =
                                    Intent(context, ShowHostelDataActivity::class.java)
                                intent.putExtra("id", id)
                                context!!.startActivity(intent)
                            }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: HostelownsampleBinding =
            HostelownsampleBinding.bind(itemView)
    }
}