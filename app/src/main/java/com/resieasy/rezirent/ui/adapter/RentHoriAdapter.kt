...
class RentHoriAdapter(var context: Context, var list: ArrayList<AddFlatClass>) :
    RecyclerView.Adapter<RentHoriAdapter.ViewHolder>() {
    fun updateList(newList: ArrayList<AddFlatClass>) {
        list.clear()
        list.addAll(newList)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(context).inflate(R.layout.renthorizontalsample, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: RenthorizontalsampleBinding =
            RenthorizontalsampleBinding.bind(itemView)
    }
}
