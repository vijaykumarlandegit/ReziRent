...
class SellHoriAdapter(var context: Context, var list: ArrayList<SellResiClass>) :
    RecyclerView.Adapter<SellHoriAdapter.ViewHolder>() {
    fun updateList(newList: ArrayList<SellResiClass>) {
        list.clear()
        list.addAll(newList)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(context).inflate(R.layout.homesellhorizontalsample, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (prize!!.isEmpty()) {
            holder.binding.prizeview.visibility = View.INVISIBLE
        } else {
            holder.binding.sellsampleprize.text = prize + "₹"
        }
        ...
        FirebaseFirestore.getInstance().collection("Nanded")
            ...
            .addOnSuccessListener { snapshot ->
                ...
                Picasso.get().load(firstimage).placeholder(R.drawable.iplaceholdr)
                    .into(holder.binding.sampleimage)
            }
        holder.binding.cartmainsellview.setOnClickListener {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: HomesellhorizontalsampleBinding =
            HomesellhorizontalsampleBinding.bind(itemView)
    }
}
