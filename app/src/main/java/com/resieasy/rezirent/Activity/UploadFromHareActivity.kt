...
class UploadFromHareActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUploadFromHareBinding.inflate(
            layoutInflater
        )
        ...
        binding!!.resntview.setOnClickListener {
            val intent = Intent(
                this@UploadFromHareActivity,
                AddResidencyActivity::class.java
            )
        ...
        binding!!.sellview.setOnClickListener {
            val intent = Intent(
                this@UploadFromHareActivity,
                AddSellResiActivity::class.java
            )
            startActivity(intent)
        }
