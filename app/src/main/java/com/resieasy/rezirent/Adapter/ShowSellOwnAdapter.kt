...
class ShowSellOwnAdapter(var context: Context?, var list: ArrayList<SingleIDClass?>) :
    RecyclerView.Adapter<ShowSellOwnAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.showsellownersample, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        InterstitialAd.load(
            context!!, R.string.Ownselleditinterstitial_id.toString(), adRequestedit,
        ...
        InterstitialAd.load(
            context!!, R.string.Ownsellshowinterstitial_id.toString(), adRequestshow,
            object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    // The mInterstitialAd reference will be null until
                    // an ad is loaded.
        ...
        FirebaseFirestore.getInstance().collection("Nanded")
            ...
            .addOnSuccessListener { snapshot ->
                ...
                val size = snapshot.getString("size")
                ...
                if (prize!!.isEmpty()) {
                    holder.binding.prize.text = "Didn't given"
                } else {
                    holder.binding.prize.text = prize + "₹"
                }
                if (prize.isEmpty()) {
                    holder.binding.size.text = "Didn't given"
                } else {
                                    ...
                                    .addOnSuccessListener {
                                        FirebaseFirestore.getInstance().collection("Nanded")
                                            ...
                                            .delete().addOnSuccessListener {
                                                ...
                                                Toast.makeText(
                                                    context,
                                                    "Your property account deleted successfully",
                                                    Toast.LENGTH_LONG
                                                ).show()
        ...
        holder.binding.editview.setOnClickListener {
            if (mInterstitialAdedit != null) {
                    ...
                    mInterstitialAdedit!!.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            override fun onAdDismissedFullScreenContent() {
                                ...
                                mInterstitialAdedit = null
                                val intent =
                                    Intent(context, EditSellDataActivity::class.java)
                ...
                val intent = Intent(context, EditSellDataActivity::class.java)
                intent.putExtra("id", id)
                context!!.startActivity(intent)
            }
        }
                    ...
                    mInterstitialAdshow!!.fullScreenContentCallback =
                        object : FullScreenContentCallback() {
                            override fun onAdDismissedFullScreenContent() {
                                ...
                                mInterstitialAdshow = null
                                val intent =
                                    Intent(context, ShowSellDataActivity::class.java)
                                intent.putExtra("id", id)
                                context!!.startActivity(intent)
                            }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: ShowsellownersampleBinding =
            ShowsellownersampleBinding.bind(itemView)
    }
}
